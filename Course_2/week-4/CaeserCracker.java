...
public class CaeserCracker {
    ...
    public CaeserCracker() {
        mostCommon = 'e';
    }
    
    public CaeserCracker(char c) {
        mostCommon = c;
    }
    ...
    public String decrypt(String encrypted){
        ...
        ObjectOrientedCaeserCipher cc = new ObjectOrientedCaeserCipher(key);
        return cc.decrypt(encrypted);
    }
    
    public static void main(String[] args) {
    	CaeserCracker cracker = new CaeserCracker();
